...
var QuotationsApi = (function () {
    function QuotationsApi(basePathOrUsername, password, basePath) {
    ...
    Object.defineProperty(QuotationsApi.prototype, "useQuerystring", {
        set: function (value) {
    ...
    Object.defineProperty(QuotationsApi.prototype, "basePath", {
        get: function () {
    ...
    QuotationsApi.prototype.setDefaultAuthentication = function (auth) {
        this.authentications.default = auth;
    };
    QuotationsApi.prototype.setApiKey = function (key, value) {
        this.authentications[QuotationsApiApiKeys[key]].apiKey = value;
    };
    QuotationsApi.prototype.quotationsEmailDocumentPost = function (authorization, sendEmailSimple, options) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                localVarPath = this.basePath + '/quotations/email-document';
    ...
    QuotationsApi.prototype.quotationsGet = function (authorization, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, produces, localVarFormParams, localVarUseFormData, localVarRequestOptions, authenticationPromise;
            var _this = this;
            return __generator(this, function (_a) {
                localVarPath = this.basePath + '/quotations';
                localVarQueryParameters = {};
                localVarHeaderParams = Object.assign({}, this.defaultHeaders);
                produces = ['application/json'];
                if (produces.indexOf('application/json') >= 0) {
    ...
    QuotationsApi.prototype.quotationsIdAttachmentPost = function (authorization, id, file, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            ...
            var _this = this;
            return __generator(this, function (_a) {
                localVarPath = this.basePath + '/quotations/{id}/attachment'
    ...
    QuotationsApi.prototype.quotationsIdGet = function (authorization, id, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, produces, localVarFormParams, localVarUseFormData, localVarRequestOptions, authenticationPromise;
            var _this = this;
            return __generator(this, function (_a) {
                localVarPath = this.basePath + '/quotations/{id}'
                    .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
                localVarQueryParameters = {};
                localVarHeaderParams = Object.assign({}, this.defaultHeaders);
                produces = ['application/json'];
    ...
    QuotationsApi.prototype.quotationsInlinePost = function (authorization, inlineDocument, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, produces, localVarFormParams, localVarUseFormData, localVarRequestOptions, authenticationPromise;
            var _this = this;
            return __generator(this, function (_a) {
                localVarPath = this.basePath + '/quotations/inline';
                localVarQueryParameters = {};
                localVarHeaderParams = Object.assign({}, this.defaultHeaders);
                produces = ['application/json'];
                if (produces.indexOf('application/json') >= 0) {
    ...
    QuotationsApi.prototype.quotationsPost = function (authorization, simpleDocument, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, produces, localVarFormParams, localVarUseFormData, localVarRequestOptions, authenticationPromise;
            var _this = this;
