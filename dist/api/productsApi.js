...
class ProductsApi {
                ...
                return new Promise((resolve, reject) => {
                    localVarRequest(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            ...
                            body = models_1.ObjectSerializer.deserialize(body, "ProductResponse");
    ...
    productsIdDelete(authorization, id, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    productsIdGet(authorization, id, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/products/{id}'
                .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
            let localVarQueryParameters = {};
