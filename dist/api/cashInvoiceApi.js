...
var CashInvoiceApi = (function () {
    function CashInvoiceApi(basePathOrUsername, password, basePath) {
    ...
    Object.defineProperty(CashInvoiceApi.prototype, "useQuerystring", {
        set: function (value) {
    ...
    Object.defineProperty(CashInvoiceApi.prototype, "basePath", {
        get: function () {
    ...
    CashInvoiceApi.prototype.setDefaultAuthentication = function (auth) {
        this.authentications.default = auth;
    };
    CashInvoiceApi.prototype.setApiKey = function (key, value) {
        this.authentications[CashInvoiceApiApiKeys[key]].apiKey = value;
    };
    CashInvoiceApi.prototype.cashInvoicesGet = function (currentPage, pageSize, authorization, sortBy, filter, options) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                localVarPath = this.basePath + '/cash-invoices';
    ...
    CashInvoiceApi.prototype.cashInvoicesIdDelete = function (authorization, id, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, produces, localVarFormParams, localVarUseFormData, localVarRequestOptions, authenticationPromise;
            var _this = this;
            return __generator(this, function (_a) {
                localVarPath = this.basePath + '/cash-invoices/{id}'
    ...
    CashInvoiceApi.prototype.cashInvoicesIdGet = function (authorization, id, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, produces, localVarFormParams, localVarUseFormData, localVarRequestOptions, authenticationPromise;
            var _this = this;
    ...
    CashInvoiceApi.prototype.cashInvoicesIdPut = function (authorization, id, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, produces, localVarFormParams, localVarUseFormData, localVarRequestOptions, authenticationPromise;
            var _this = this;
    ...
    CashInvoiceApi.prototype.cashInvoicesPost = function (authorization, simpleDocument, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, produces, localVarFormParams, localVarUseFormData, localVarRequestOptions, authenticationPromise;
            var _this = this;
