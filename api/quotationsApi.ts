...
export class QuotationsApi {
     ...
     * @param authorization 
     */
    public async quotationsGet (authorization: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SimpleDocumentResponse;  }> {
     ...
     * @param file 
     */
    public async quotationsIdAttachmentPost (authorization: string, id: string, file?: RequestFile, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
    ...
    /**
     * 
     * @summary change status document quotations
     * @param authorization 
     ...
     */
    public async quotationsIdStatusKeyStatusIdPost (authorization: string, id: string, statusId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: StatusResponse;  }> {
    ...
    /**
     * 
     * @summary Share Document quotations
     * @param authorization 
     * @param shareDocument 
     */
